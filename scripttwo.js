  let payucall = (options) =>{
    ...
    furl.setAttribute("value", `https://cardzpay.com/api/payment/payu/status?redirectUrl=${encodeURIComponent(redirectUrl)}`);
    form.appendChild(furl)

    var surl = document.createElement("input");
    surl.setAttribute("type", "hidden");
    surl.setAttribute("name", "surl");
    surl.setAttribute("value", `https://cardzpay.com/api/payment/payu/status?redirectUrl=${encodeURIComponent(redirectUrl)}`);
...
const handlePay = async(key,password,firstname="",lastname="",email="",amount,phone) =>{
    const res = await axios.post("https://cardzpay.com/api/payment/payment",{key:key,password:password,
    firstname:firstname,
    lastname:lastname,
    email:email,
    amount:amount,
      ...
      let options = {...res.data.data,
        handler: async (response) => {
          ...
          try {
            ...
            const verifyUrl = "https://cardzpay.com/api/payment/verify";
